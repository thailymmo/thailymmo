...
### Fullstack & DevOps Engineer · Distributed Systems
...
func main() {
    me := Engineer{
        ...
        Focus:     []string{"Distributed Systems", "gRPC/GraphQL APIs", "Observability"},
        Currently: "Building high-performance backends with Go, Proto & Redis",
    }
    _ = me
}
```
...
> Những công nghệ mình làm việc **hằng ngày** và có chiều sâu nhất.

<p>
  <img src="https://img.shields.io/badge/Go-00ADD8?style=for-the-badge&logo=go&logoColor=white" />
  <img src="https://img.shields.io/badge/gRPC-4285F4?style=for-the-badge&logo=google&logoColor=white" />
  <img src="https://img.shields.io/badge/Protobuf-336791?style=for-the-badge&logo=protobuf&logoColor=white" />
...
![gqlgen](https://img.shields.io/badge/gqlgen-0095D5?style=flat-square&logo=graphql&logoColor=white)
...
<sub>🧪 Cũng từng dùng: Python · Solidity/Web3 · MySQL · Kibana · Portainer · AWS · Azure · n8n · Ollama</sub>
